...
class BookmarkViewController: UIViewController {
    ...
    @IBAction func saveButtonTapped(_ sender: UIButton) {
        ...
        tempSave.forEach { productName in
            _ = saveCoreData(productName: productName)
        }
        tempSave.removeAll()
        showData.removeAll()
        for managedObject in productBookmarkedData {
...
extension BookmarkViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let width: CGFloat = collectionView.frame.width / 3 - 10.0
...
//
//        // initView에서 cell 선택 시
//        if initView.isHidden == false {
//            //            tempSave.append(productAllData[indexPath.row])
//            //            let cell = collectionView.cellForItem(at: indexPath)
//            //            cell?.backgroundView = UIImageView(image: UIImage(named: "BookmarkCheckedImage"))
//            //
//            //            print(productAllData[indexPath.row])
//            //            print("tempSave : \(tempSave.count)")
//            //            print("tempSave : \(tempSave)")
//
//        }
//        // addView에서 cell 선택 시
//        if addView.isHidden == false {
//            if self.bookmarkCollectionView.allowsMultipleSelection == true {
//                let cell = self.bookmarkCollectionView.cellForItem(at: indexPath)
