//
//  CheckGraphViewController.swift
//  farm2Seoul-frontend-ios
//
//  Created by 강보현 on 2023/04/30.
//
...
class CheckGraphViewController: UIViewController {
...
//        chart.leftAxis.axisMaximum = 최대
    ...
    func getDetailData(detailData: String) {
        self.productName = detailData
        self.rank = "상"
        (self.quantity, self.unit) = separateNumberAndUnit(from:"10kg상자") ?? ("0.00", "")
    }
