...
class DetailInfoViewController: UIViewController {
    ...
    func getDetailData(detailData: DailyAuctionResponse) {
        ...
        self.avrPrice = String(numberFormatter(number: detailData.avrPrice))
        self.maxPrice = String(numberFormatter(number: detailData.maxPrice))
        self.minPrice = String(numberFormatter(number: detailData.minPrice))
